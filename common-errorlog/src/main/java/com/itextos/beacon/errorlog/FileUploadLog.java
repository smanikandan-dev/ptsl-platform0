...
public class FileUploadLog {
    ...
    private static final  Logger logger = Logger.getLogger(FileUploadLog.class.getName());
    ...
    static {
        ...
        String logFileNamePattern = "/opt/jboss/wildfly/logs/fileupload.%g.log";
    ...
    private static FileUploadLog obj=new FileUploadLog();
    
    public static FileUploadLog getInstance() {
    	
    	if(obj==null) {
    		obj=new FileUploadLog();
    	}
