...
public class K2ESLog {


    private static final  Logger logger = Logger.getLogger(K2ESLog.class.getName());
    ...
    static {
        ...
        String logFileNamePattern = "/opt/jboss/wildfly/logs/k2es.%g.log";
    ...
    private static K2ESLog obj=new K2ESLog();
    
    public static K2ESLog getInstance() {
