...
public class ConcateRedisLog {


    private static final  Logger logger = Logger.getLogger(ConcateRedisLog.class.getName());
    ...
    static {
        ...
        String logFileNamePattern = "/opt/jboss/wildfly/logs/concateredis.%g.log";
    ...
    private static ConcateRedisLog obj=new ConcateRedisLog();
    
    public static ConcateRedisLog getInstance() {
    	
    	if(obj==null) {
    		obj=new ConcateRedisLog();
    	}
