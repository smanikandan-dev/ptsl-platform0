...
public class ErrorLogTableInserter
        extends
        AbstractTableInserterWrapper
{

    private static final Log       log            = LogFactory.getLog(ErrorLogTableInserter.class);
    private static final Component THIS_COMPONENT = Component.T2DB_ERROR_LOG;

    public ErrorLogTableInserter(
            String aThreadName,
            ...
            int aSleepInMillis)
    {
        super(aThreadName, aComponent, aPlatformCluster, aTopicName, aConsumerInMemCollection, aSleepInMillis, Table2DBInserterId.ERROR_LOG);
    }
