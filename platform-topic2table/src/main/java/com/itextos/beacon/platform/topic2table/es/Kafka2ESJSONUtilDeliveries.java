...
public class Kafka2ESJSONUtilDeliveries
{
            ...
            IMessage iMsg)
    {
        ...
        subJSON.put(DeliveriesK2ES.ESIndexUniqueColumn, msgId);

        final String dataUpdTime = DateTimeUtility.getFormattedCurrentDateTime(DateTimeFormat.DEFAULT);
        subJSON.put(DeliveriesK2ES.ESDocUpdTmColumn, dataUpdTime);
            ...
            String baseMsgId)
    {
        ...
        fmsgJSON.put(DeliveriesK2ES.ESFmsgIndexUniqueColumn, baseMsgId);
            ...
            IMessage iMsg)
    {
        ...
        final String dataUpdTime = DateTimeUtility.getFormattedCurrentDateTime(DateTimeFormat.DEFAULT);
        delJSON.put(DeliveriesK2ES.ESDocUpdTmColumn, dataUpdTime);
