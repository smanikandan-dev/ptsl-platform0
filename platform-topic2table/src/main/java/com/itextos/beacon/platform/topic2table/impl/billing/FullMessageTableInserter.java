        ...
        AbstractTableInserterWrapper
{
    ...
    private static final Component THIS_COMPONENT = Component.T2DB_FULL_MESSAGE;
    ...
    public FullMessageTableInserter(
            ...
            int aSleepInMillis)
    {
        super(aThreadName, aComponent, aPlatformCluster, aTopicName, aConsumerInMemCollection, aSleepInMillis, Table2DBInserterId.FULL_MESSAGE);
    }
