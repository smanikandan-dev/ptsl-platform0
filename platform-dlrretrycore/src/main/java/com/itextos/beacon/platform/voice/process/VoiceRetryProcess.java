package com.itextos.beacon.platform.voice.process;
        ...
        AbstractKafkaComponentProcessor
{
    ...
    private static final Log log = LogFactory.getLog(VoiceRetryProcess.class);

    public VoiceRetryProcess(
            String aThreadName,
            ...
            BaseMessage aBaseMessage)
    {
        if (log.isDebugEnabled())
            log.debug("Message Received Dlr Retry component : " + aBaseMessage);
    }
