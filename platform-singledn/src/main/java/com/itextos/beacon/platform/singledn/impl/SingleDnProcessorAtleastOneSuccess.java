...
public class SingleDnProcessorAtleastOneSuccess
        extends
        AbstractSingleDnProcess
{

    private static final Log log = LogFactory.getLog(SingleDnProcessorAtleastOneSuccess.class);

    public SingleDnProcessorAtleastOneSuccess(
