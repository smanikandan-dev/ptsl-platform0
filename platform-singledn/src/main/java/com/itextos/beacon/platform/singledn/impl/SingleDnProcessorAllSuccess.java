...
public class SingleDnProcessorAllSuccess
        extends
        AbstractSingleDnProcess
{

    private static final Log log = LogFactory.getLog(SingleDnProcessorAllSuccess.class);

    public SingleDnProcessorAllSuccess(
            ...
            throws ItextosException
    {
        ...
        if (returnValue)
        {
            ...
            {
                mIsValidationSuccess = isAllSuccess() ? ValidationStatus.SUCCESS : ValidationStatus.FAILED;
                returnValue          = true;
            }
        }
    ...
    {
        validFailure.add(DNDeliveryMode.AVAILABLE_FIRST_FAILURE_PART);
        validFailure.add(DNDeliveryMode.AVAILABLE_LAST_FAILURE_PART);
        validFailure.add(DNDeliveryMode.EARLIEST_FAILURE_DELIVERED);
        validFailure.add(DNDeliveryMode.LATEST_FAILURE_DELIVERED);
    }
