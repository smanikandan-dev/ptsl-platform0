...
public class SingleDnProcessorPartialFailure
        extends
        AbstractSingleDnProcess
{
    ...
    public SingleDnProcessorPartialFailure(
    ...
    {
        validSuccess.add(DNDeliveryMode.AVAILABLE_FIRST_FAILURE_PART);
        validSuccess.add(DNDeliveryMode.AVAILABLE_LAST_FAILURE_PART);
        validSuccess.add(DNDeliveryMode.EARLIEST_FAILURE_DELIVERED);
        validSuccess.add(DNDeliveryMode.LATEST_FAILURE_DELIVERED);
    }
