...
public class Kafka2ElasticsearchProperties
{

    private static final Log    log                                   = LogFactory.getLog(Kafka2ElasticsearchProperties.class);
    ...
    private static class SingletonHolder
    {
        ...
        static final Kafka2ElasticsearchProperties INSTANCE = new Kafka2ElasticsearchProperties();

    }

    public static Kafka2ElasticsearchProperties getInstance()
    {
        return SingletonHolder.INSTANCE;
    }

    private final PropertiesConfiguration mProps = PropertyLoader.getInstance().getPropertiesConfiguration(PropertiesPath.KAFKA_2_ELASTICSEARCH_PROPERTIES, true);
    ...
    private Kafka2ElasticsearchProperties()
    {
