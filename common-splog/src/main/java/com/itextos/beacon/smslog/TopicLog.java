...
public class TopicLog {
    ...
    private static LinkedHashMap<String, TopicLog> objmap = new LinkedHashMap<>();

    private String label; // Label for the log entries

    // Public method to get the singleton instance for each topic
    public static synchronized TopicLog getInstance(String topicname) {
        synchronized (objmap) {
    ...
    private TopicLog(String topicname) {
