...
public class StartupFlowLog {


    private static final  Logger logger = Logger.getLogger(StartupFlowLog.class.getName());
    ...
    static {
        ...
        String logFileNamePattern = "/opt/jboss/wildfly/logs/startupflow.%g.log";
