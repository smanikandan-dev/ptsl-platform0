...
public class ComponentProcessorLog {


    private static final  Logger logger = Logger.getLogger(ComponentProcessorLog.class.getName());
    ...
    static {
        ...
        String logFileNamePattern = "/opt/jboss/wildfly/logs/threadcomponentprocessor.%g.log";
