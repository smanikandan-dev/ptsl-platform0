...
public class DnTimeStampLog {


    private static final  Logger logger = Logger.getLogger(DnTimeStampLog.class.getName());
    ...
    static {
        ...
        String logFileNamePattern = "/opt/jboss/wildfly/logs/dntimestamp.%g.log";
