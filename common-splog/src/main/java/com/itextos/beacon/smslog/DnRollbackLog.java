...
public class DnRollbackLog {


    private static final  Logger logger = Logger.getLogger(DnRollbackLog.class.getName());
    ...
    static {
        ...
        String logFileNamePattern = "/opt/jboss/wildfly/logs/dnrollback.%g.log";
