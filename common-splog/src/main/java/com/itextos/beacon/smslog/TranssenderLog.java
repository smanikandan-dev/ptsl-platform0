...
public class TranssenderLog {


    private static final  Logger logger = Logger.getLogger(TranssenderLog.class.getName());
    ...
    static {
         ...
         int count = 1; // N
        String logFileNamePattern = "/opt/jboss/wildfly/logs/kafkasender/transsender.%g.log";
