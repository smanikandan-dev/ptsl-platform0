...
public class ConsumerTopicList {


    private static final  Logger logger = Logger.getLogger(ConsumerTopicList.class.getName());
    ...
    static {
        ...
        String logFileNamePattern = "/opt/jboss/wildfly/logs/consumer/consumertopiclist.%g.log";
