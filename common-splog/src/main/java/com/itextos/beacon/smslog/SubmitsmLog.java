...
public class SubmitsmLog {


    private static final  Logger logger = Logger.getLogger(SubmitsmLog.class.getName());
    ...
    static {
        ...
        String logFileNamePattern = "/opt/jboss/wildfly/logs/submitsm.%g.log";
