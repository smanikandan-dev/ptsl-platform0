...
public class DnSendLog {


    private static final  Logger logger = Logger.getLogger(DnSendLog.class.getName());
    ...
    static {
        ...
        String logFileNamePattern = "/opt/jboss/wildfly/logs/dnsent.%g.log";
