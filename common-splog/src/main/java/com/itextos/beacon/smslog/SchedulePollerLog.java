...
public class SchedulePollerLog {


    private static final  Logger logger = Logger.getLogger(SchedulePollerLog.class.getName());
    
    static {
    	 int limit = 1024 * 1024*5; // 1 MB file size limit
         int count = 1; // N

        String logFileNamePattern = "/opt/jboss/wildfly/logs/aux/shedulepoller.%g.log";
