...
public class SmppSMErrorLog {


    private static final  Logger logger = Logger.getLogger(SmppSMErrorLog.class.getName());
    ...
    static {
         ...
         int count = 1; // N
        String logFileNamePattern = "/opt/jboss/wildfly/logs/smppsmerror.%g.log";
