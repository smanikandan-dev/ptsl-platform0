...
public class SmppLog {


    private static final  Logger logger = Logger.getLogger(SmppLog.class.getName());
    
    static {
    	 int limit = 1024 * 1024*5; // 1 MB file size limit
         int count = 1; // N

        String logFileNamePattern = "/opt/jboss/wildfly/logs/aux/smpp.%g.log";
