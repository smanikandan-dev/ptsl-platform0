...
public class TransConsumerLog {


    private static final  Logger logger = Logger.getLogger(TransConsumerLog.class.getName());
    ...
    static {
        ...
        String logFileNamePattern = "/opt/jboss/wildfly/logs/consumer/transconsumer.%g.log";
