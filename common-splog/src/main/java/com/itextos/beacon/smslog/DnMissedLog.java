...
public class DnMissedLog {


    private static final  Logger logger = Logger.getLogger(DnMissedLog.class.getName());
    ...
    static {
        ...
        String logFileNamePattern = "/opt/jboss/wildfly/logs/dnmissed.%g.log";
