...
public class JSONReceiverLog {


    private static final  Logger logger = Logger.getLogger(JSONReceiverLog.class.getName());
    ...
    static {
        ...
        String logFileNamePattern = "/opt/jboss/wildfly/logs/jsonreceiver.%g.log";
