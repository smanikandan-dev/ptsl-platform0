...
public class K2EPushLog {


    private static final  Logger logger = Logger.getLogger(K2EPushLog.class.getName());
    ...
    static {
        ...
        String logFileNamePattern = "/opt/jboss/wildfly/logs/k2e/k2epush.%g.log";
