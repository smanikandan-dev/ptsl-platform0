...
public class PromosenderLog {


    private static final  Logger logger = Logger.getLogger(PromosenderLog.class.getName());
    ...
    static {
        ...
        String logFileNamePattern = "/opt/jboss/wildfly/logs/kafkasender/promosender.%g.log";
