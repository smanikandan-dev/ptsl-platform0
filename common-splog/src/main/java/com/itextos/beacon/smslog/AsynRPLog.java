...
public class AsynRPLog {


    private static final  Logger logger = Logger.getLogger(AsynRPLog.class.getName());
    ...
    static {
        ...
        String logFileNamePattern = "/opt/jboss/wildfly/logs/asynrp.%g.log";
