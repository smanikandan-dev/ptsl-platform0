...
public class PromoConsumerLog {


    private static final  Logger logger = Logger.getLogger(PromoConsumerLog.class.getName());
    ...
    static {
        ...
        String logFileNamePattern = "/opt/jboss/wildfly/logs/consumer/promoconsumer.%g.log";
