...
public class ProducertoRedisLog {


    private static final  Logger logger = Logger.getLogger(ProducertoRedisLog.class.getName());
    ...
    static {
        ...
        String logFileNamePattern = "//opt/jboss/wildfly/logs/producer/producertoredis.%g.log";
