...
public class TestKafkaProducer
{
    ...
    private KafkaProducer<String, IMessage> mProducerMessage;
    ...
    private void createProducer()
    {
        ...
        while (!mInitialized)
        {
            ...
            try
            {
                ...
                mProducerMessage = new KafkaProducer<>(mKafkaProperties);
            ...
            throws ItextosException
    {
        ...
        try
        {
            final ProducerRecord<String, IMessage> producerRecord = getProducerRecord(aKey, aMessage);
            mProducerMessage.send(producerRecord, callBack);
            // mProducerMessage.send(producerRecord);
            // final Future<RecordMetadata> send = mProducer.send(producerRecord, callBack);
            // sent = TestProducerCallback.updateOffsetValue(mTopicName, send.get());
    ...
    public void closeProducer()
    {
        ...
        mProducerMessage.flush();
        // mProducerMessage.close();
    }
