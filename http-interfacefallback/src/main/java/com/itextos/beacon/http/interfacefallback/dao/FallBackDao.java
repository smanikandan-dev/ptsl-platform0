...
public class FallBackDao
{

    private static final Log    log        = LogFactory.getLog(FallBackDao.class);

    private static final String INSERT_SQL = "insert into interface_fallback (messageid, priority, input_req) values (?,?,?)";
    private static final String SELECT_SQL = "select messageid, priority, input_req from interface_fallback limit 500";
    private static final String DELETE_SQL = "delete from interface_fallback where messageid=?";
