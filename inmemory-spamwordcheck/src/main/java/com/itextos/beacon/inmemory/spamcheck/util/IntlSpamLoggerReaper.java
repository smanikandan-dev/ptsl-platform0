...
public class IntlSpamLoggerReaper
        extends
        Thread
{

    private static final Log log = LogFactory.getLog(IntlSpamLoggerReaper.class);
    ...
    public void run()
    {
        ...
        while (true)
        {
            final List<IntlSpamCheckObject> spamList = IntlSpamLogger.getInstance().getSpamCheckObjects();
    ...
    private static void spamWordLogging(
            List<IntlSpamCheckObject> aSpamWordList)
    {
